...
struct ArgWrapper {
  ...
  ArgWrapper(T&& a1, U&& a2, V&& a3)
      : arg1(std::forward<T>(a1)), arg2(std::forward<U>(a2)), arg3(std::forward<V>(a3)) {}
  template <typename TCallback>
  void callCallback(TCallback&& callback) const {
    std::forward<TCallback>(callback)(std::move(arg1), std::move(arg2), std::move(arg3));
  }
};
...
class SimpleThread {
 ...
 public:
  ...
  SimpleThread(SimpleThread&& other) : thread(other.thread) { other.thread = nullptr; }
 ...
 public:
  ...
  explicit SimpleThread(TCallback&& callback, TArg1&& arg1) {
    auto wrapper = new CallbackWrapper<TCallback, details::ArgWrapper<TArg1>>(
        std::forward<TCallback>(callback), details::ArgWrapper<TArg1>(std::forward<TArg1>(arg1)));
  ...
  explicit SimpleThread(TCallback&& callback, TArg1&& arg1, TArg2&& arg2, TArg3&& arg3) {
    auto wrapper = new CallbackWrapper<TCallback, details::ArgWrapper<TArg1, TArg2, TArg3>>(
        ...
        details::ArgWrapper<TArg1, TArg2, TArg3>(
            std::forward<TArg1>(arg1), std::forward<TArg2>(arg2), std::forward<TArg3>(arg3)));
